...
parser.add_argument('--residual_min_d',type=float, default=0.0)
parser.add_argument('--residual_max_d',type=float, default=10.0)
parser.add_argument('--residual_type_d',type=str, default='uniform')
...
parser.add_argument('--save_refined_pred', action='store_true')
parser.add_argument('--save_refined_error_map', action='store_true')
...
parser.add_argument('--use_my_loss',action='store_true')
parser.add_argument('--my_loss_name',default='',type=str)
parser.add_argument('--my_loss_weight',default=0.1,type=float)
parser.add_argument('--my_pad_type',default="",type=str)
parser.add_argument('--my_pad_prob',default=-1.,type=float)
